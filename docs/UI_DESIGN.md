...
│ Home   Library   Studio   Practice   Author              ⚙ Settings │
├──────────────┬──────────────────────────────────────────────────┤
...
- Filters: all / to do / done — in the title row next to Export, not on a row of their own. Three pills and one button do not each earn a full-width band
